...
public class Test {
    ...
    private static double eta       =    0.5, fractionOfTrainingToUse = 1.00, dropoutRate = 0.00,momentum = 0.0, weight_decay = 0.; // To turn off drop out, set dropoutRate to 0.0 (or a neg number).
